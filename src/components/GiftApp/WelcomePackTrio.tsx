...
const VIDEO_URL = "/Trio/video.mp4"; // Path to the video in the public folder
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 h-full">
              <div className="space-y-1 mr-[-40%]"> {/* Added mr-2 for right margin */}
                <img 
                  src="/Trio/1.png" // Reference the image in the public folder
                  alt="Leather wallet"
                  className="w-[35%] h-[160px] object-cover mx-auto"
                />
                <img 
                  src="/Trio/2.png" // Reference the image in the public folder
                  alt="Belt closeup"
                  className="w-[35%] h-[160px] object-cover mx-auto"
                />
                <img 
                  src="/Trio/3.png" // Reference the image in the public folder
                  alt="Keychain detail"
                  className="w-[35%] h-[160px] object-cover mx-auto"
                />
              </div>
